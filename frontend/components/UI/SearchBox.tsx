...
export default function SearchBox({ buildings, onSearch, onSelectResult }: SearchBoxProps) {
  ...
  return (
    <div ref={wrapperRef} className="relative mb-4 z-50">
      ...
      <input
        type="text"
        className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 text-gray-900 focus:outline-none focus:placeholder-gray-400 focus:border-blue-300 focus:ring focus:ring-blue-200 sm:text-sm shadow-sm"
